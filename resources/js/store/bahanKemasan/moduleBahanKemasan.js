...
const actions = {
  async list({ commit }) {
    try{
      const response = await axios.post('/api/bahanKemasan/list', {
        headers: {
...
async needRestock({ commit }) {
    try{
      const response = await axios.post('/api/bahanKemasan/stock/needRestock', {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
      })
  ...
  async process({ commit }, data) {
    ...
    return new Promise((resolve, reject) => {
      axios.post("/api/bahanKemasan/" + transactionType, data.formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      })
  ...
  delete({commit}, data){
    return new Promise((resolve, reject)=>{
      axios.delete(`/api/bahanKemasan/delete/${data.id}`)
      .then((response)=>{
  ...
  async listLog({ commit }) {
    try{
      const response = await axios.post('/api/bahanKemasan/restock/list', {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
      })
  ...
  async processLog({ commit }, data) {
    ...
    return new Promise((resolve, reject) => {
      axios.post("/api/bahanKemasan/restock/" + transactionType, data.formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      })
  ...
  deleteLog({commit}, data){
    return new Promise((resolve, reject)=>{
      axios.delete(`/api/bahanKemasan/restock/delete/${data.id}`)
      .then((response)=>{
  ...
  async listStock({ commit }) {
    try{
      const response = await axios.post('/api/bahanKemasan/stock/list', {
        headers: {
            'Content-Type': 'multipart/form-data'
        }
      })
  ...
  async stock({ commit }) {
      try{
        const response = await axios.post('/api/bahanKemasan/stock/getStock', {
          headers: {
              'Content-Type': 'multipart/form-data'
          }
        })
