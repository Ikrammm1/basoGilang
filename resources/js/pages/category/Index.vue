    ...
    <div>
        ...
        >
            ...
            <template #item.icon="{ item }">
                ...
                >
                <VImg :src="item.icon ? '/images/category/'+item.icon : '/images/avatars/profilephoto.png'" :style="{ borderRadius: '20px', margin:'15px'}"/>
                </VAvatar>
...
export default {
    ...
    computed:{
        ...
        datas() {
            ...
            const data = this.$store.state.category.datas;
