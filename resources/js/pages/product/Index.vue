    ...
    <div>
        ...
        >
            ...
            <template #item.image="{ item }">
                ...
                <VImg :src="item.image ? '/images/product/'+item.image : '/images/avatars/profilephoto.png'" :style="{  width:'80px',borderRadius: '20px', margin:'10px'}"/>

                <!-- <span>{{ item.image ? item.image : '-'}}</span> -->
            </template>
            ...
            <template #item.price="{ item }">
                <span>{{ item.price ?formatRupiah(item.price) : '-' }}</span>
            </template>
            <!-- Actions -->
